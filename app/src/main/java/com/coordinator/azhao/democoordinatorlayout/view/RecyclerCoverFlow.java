...
public class RecyclerCoverFlow extends RecyclerView {
	 ...
	 * 布局器构建者
	 */
	private com.coordinator.azhao.democoordinatorlayout.view.CoverFlowLayoutManger.Builder mManagerBuilder;
	...
	private void createManageBuilder() {
		if (mManagerBuilder == null) {
			mManagerBuilder = new com.coordinator.azhao.democoordinatorlayout.view.CoverFlowLayoutManger.Builder();
		}
	}
	...
	public void setLayoutManager(LayoutManager layout) {
		/*if (!(layout instanceof com.coordinator.azhao.democoordinatorlayout.view.CoverFlowLayoutManger)) {
	 ...
	 */
	public com.coordinator.azhao.democoordinatorlayout.view.CoverFlowLayoutManger getCoverFlowLayout() {
		return ((com.coordinator.azhao.democoordinatorlayout.view.CoverFlowLayoutManger) getLayoutManager());
	}
	 ...
	 * @param l 监听接口
	 */
	public void setOnItemSelectedListener(com.coordinator.azhao.democoordinatorlayout.view.CoverFlowLayoutManger.OnSelected l) {
