...
public class CoverFlowLayoutManger extends RecyclerView.LayoutManager {
	...
	public CoverFlowLayoutManger(boolean isFlat, boolean isGreyItem, boolean isAlphaItem, float cstInterval) {
		mIsFlatFlow = isFlat;
	...
	private void greyItem(View child, Rect frame) {
		...
		ColorMatrix cm = new ColorMatrix(new float[]{value, 0, 0, 0, 120 * (1 - value), 0, value, 0, 0, 120 * (1 - value), 0, 0, value, 0, 120 * (1 - value), 0, 0, 0, 1, 250 * (1 - value),});
	...
	public static class Builder {
		...
		public com.coordinator.azhao.democoordinatorlayout.view.CoverFlowLayoutManger build() {
			return new com.coordinator.azhao.democoordinatorlayout.view.CoverFlowLayoutManger(isFlat, isGreyItem, isAlphaItem, cstIntervalRatio);
		}
	}
